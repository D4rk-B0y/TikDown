...
class Main():
    try:
        ...
        def start():
            ...
            os.system(f"title BACKUP TOOL ^| Abir#Rahman ^| STATUS: LOADING")
            ...
            Anime.Fade(Center.Center("BY Abir#Rahman"), Colors.blue_to_red, Colorate.Vertical, interval=0.01, time=3)
